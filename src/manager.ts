...
export function setLaserCooldown(val: number) { laserCooldown = val; }
...
export function makeBall(stick = true, angle: number | null = null): S.Ball {
...
export function resetBalls(stick = true): void {
...
export function setMaxBalls(count: number): void {
    S.setMaxBallCount(count);
}

export function applyPaddleWidthByPower(): void {
...
export function applyItem(type: C.ItemType): void {
    switch (type) {
