...
export let balls = []; // b.trails: [] 배열 포함 예정
export let bricks = [];
export let items = [];
export let lasers = []; // 레이저

// 파워업 타이머
export let extendTimer = 0;
export let fullWidthTimer = 0;
export let laserTimer = 0; // 레이저 타이머
...
export function resetLasers() { lasers.length = 0; } // 레이저 리셋

// --- 최고 점수 관리 ---
export function loadHighScore() {
    highScore = parseInt(localStorage.getItem('arkanoidHighScore')) || 0;
}
